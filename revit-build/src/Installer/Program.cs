...
internal sealed class InstallerForm : Form
{
    ...
    public InstallerForm()
    {
        ...
        header.Controls.Add(new Label { Text = "Interactive electrical flex routing • Systems ribbon integration", ForeColor = Color.FromArgb(215, 224, 239), AutoSize = true, Location = new Point(31, 57) });
        Controls.Add(header);

        var body = new Panel { Location = new Point(28, 118), Size = new Size(604, 198), BackColor = Color.White, BorderStyle = BorderStyle.FixedSingle };
        ...
        _status.Location = new Point(31, 334);
        Controls.Add(_status);

        _progress.Location = new Point(31, 365);
        _progress.Size = new Size(268, 12);
        Controls.Add(_progress);

        var install = new Button { Text = "Install", Size = new Size(100, 38), Location = new Point(320, 348) };
        install.Click += (_, _) => Install();
        Controls.Add(install);

        var uninstall = new Button { Text = "Uninstall", Size = new Size(100, 38), Location = new Point(428, 348) };
        uninstall.Click += (_, _) => Uninstall();
        Controls.Add(uninstall);

        var close = new Button { Text = "Close", Size = new Size(100, 38), Location = new Point(536, 348) };
    ...
    private void Install()
    {
        try
        {
            ...
            {
                MessageBox.Show(this, "Please close Autodesk Revit before installing.", ProductName, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }

            _status.Text = "Status: Installing...";
            _progress.Value = 15;
            ...
            _progress.Value = 100;
            _status.Text = "Status: Installed successfully";
            MessageBox.Show(this,
                "Flex Conduit was installed successfully.\r\n\r\nOpen Revit 2025 and use Systems > Flex Conduit.",
                ProductName,
    ...
    private void Uninstall()
    {
        try
        {
            ...
            string addinPath = Path.Combine(AddinDir, AddinFileName);
